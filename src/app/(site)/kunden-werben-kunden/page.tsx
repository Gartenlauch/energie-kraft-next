...
import { REFERRAL_REWARD_EURO, referralCampaignTerms } from "@/content/referral-campaign";
        ...
        <section className="section-space bg-background" aria-labelledby="referral-intro-title">
          <div className="section-shell grid gap-12 lg:grid-cols-[0.75fr_1.25fr] lg:items-start">
            <Reveal>
              ...
              <p className="mt-3 text-sm font-bold tracking-[0.12em] uppercase">
                pro erfolgreicher Empfehlung
              </p>
            </Reveal>
            <Reveal delay={70}>
              <h2 id="referral-intro-title" className="section-title">
                Gute Erfahrungen dürfen nachhaltige Projekte anstoßen.
              </h2>
              <p className="lead-copy mt-6">
                Eine persönliche Empfehlung ist eine besondere Anerkennung. Gleichzeitig hilft sie
                anderen dabei, erneuerbare Energie zu nutzen und Stromkosten mit einer passenden
                Photovoltaiklösung zu senken.
              </p>
              <p className="mt-5 text-base leading-8 text-[var(--text-muted)]">
                Die Prämie wird nicht schon mit dem Absenden verdient. Sie setzt einen erfolgreichen
                Vertragsabschluss sowie die unten aufgeführten Aktionsbedingungen voraus.
              </p>
            </Reveal>
          </div>
        </section>
        ...
        <section className="section-space bg-surface-soft" aria-labelledby="referral-process-title">
          <div className="section-shell">
            <Reveal>
              ...
              <h2 id="referral-process-title" className="section-title mt-4">
                Von der Empfehlung bis zur möglichen Prämie
              </h2>
            </Reveal>
            <ol className="border-border-strong mt-12 grid border-y md:grid-cols-4">
              {[
                [
                  "Kontakt übermitteln",
                  "Tragen Sie die erforderlichen Angaben zur empfohlenen Person im Formular ein.",
                ],
                [
                  "Eingang bestätigen",
                  "Sie erhalten eine Bestätigung; die empfohlene Person wird knapp über die übermittelten Daten informiert.",
                ],
                [
                  "Projekt beraten",
                  "Wir nehmen Kontakt auf, beraten, planen und erstellen ein individuelles Angebot.",
                ],
                [
                  "Prämie prüfen",
                  "Kommt es unter den Bedingungen zum Vertragsabschluss, erhalten Sie ein separates Überweisungsformular.",
                ],
              ].map(([title, description], index) => (
                <li
                  key={title}
                  className="border-border-strong py-8 md:border-l md:px-7 md:first:border-l-0"
                >
        ...
        >
          <div className="section-shell grid gap-10 lg:grid-cols-[0.72fr_1.28fr] lg:gap-20">
            <Reveal>
              ...
              <h2 id="terms-title" className="section-title mt-4 text-white">
                Was für die Aktion gilt
              </h2>
              <p className="mt-5 text-sm leading-7 text-white">
                Maßgeblich ist die Prüfung im konkreten Fall. Die Aktion ist freiwillig und kann
                beendet werden.
              </p>
            </Reveal>
            <ul className="grid gap-x-8 gap-y-4 sm:grid-cols-2">
              {referralCampaignTerms.map((term, index) => (
                <li
                  key={term}
                  className="flex gap-3 border-t border-white/25 pt-4 text-sm leading-7 text-white"
                >
        ...
        >
          <div className="section-shell grid gap-12 lg:grid-cols-[0.62fr_1.38fr] lg:items-start">
            <Reveal>
              ...
              <h2 id="form-title" className="section-title mt-4">
                In drei klaren Schritten
              </h2>
              <p className="lead-copy mt-5">
                Halten Sie Ihre eigenen Kontaktdaten und die Angaben der empfohlenen Person bereit.
                Vor dem Absenden sehen Sie eine vollständige Zusammenfassung.
              </p>
            </Reveal>
            <Reveal delay={70}>
              <ReferralForm />
